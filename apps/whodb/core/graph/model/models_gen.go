...
func (e SourceAction) IsValid() bool {
	switch e {
	case SourceActionBrowse, SourceActionInspect, SourceActionViewRows, SourceActionViewContent, SourceActionViewDefinition, SourceActionCreateChild, SourceActionDelete, SourceActionInsertData, SourceActionUpdateData, SourceActionDeleteData, SourceActionImportData, SourceActionExecute, SourceActionViewGraph:
		return true
	}
	return false
}
...
func (e SourceSurface) IsValid() bool {
	switch e {
	case SourceSurfaceBrowser, SourceSurfaceQuery, SourceSurfaceGraph:
		return true
	}
	return false
}
