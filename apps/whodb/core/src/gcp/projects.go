...
// DiscoverLocalProjects scans environment variables and gcloud configuration
...
// discoverGcloudProjects reads gcloud configuration files for project settings.
