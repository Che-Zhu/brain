    ...
    >
      ...
      >
        <thead className="border-border border-b bg-transparent">
          <tr>
            <th
              className="sticky top-0 left-0 z-50 border-border border-r border-b bg-input/30 px-2 py-2 text-center font-semibold text-muted-foreground text-xs"
            ...
            {hiddenColumnCount > 0 && (
              <th
                className="sticky top-0 z-40 border-border border-b bg-input/30 px-4 py-2 text-center font-medium text-muted-foreground text-xs"
            ...
            <th className="sticky top-0 z-40 w-full border-border border-b bg-input/30" />
          </tr>
        </thead>
          ...
          {state.renderedRows.map((row, rowIdx) => {
            ...
            return (
              ...
              >
                <td
                  className={cn(
                    "sticky left-0 z-30 border-border border-r border-b bg-transparent px-2 py-2 text-center font-normal text-sm",
