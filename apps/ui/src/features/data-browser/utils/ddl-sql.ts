...
export function deleteAllRowsSQL(
  dialect: SqlDialect,
  table: string,
  schema?: string
): string {
...
export function copyTableStructureSQL(
  dialect: SqlDialect,
  source: string,
  target: string,
  schema?: string
...
export function copyTableWithDataSQL(
  dialect: SqlDialect,
  source: string,
  target: string,
  schema?: string
...
export function addForeignKeySQL(
  ...
  return (
    `ALTER TABLE ${tbl} ADD CONSTRAINT ${quoteId(constraintName, dialect)} ` +
...
export function foreignKeysQuery(
  dialect: SqlDialect,
  database: string,
  table: string,
  schema?: string
