 ...
 * That breaks under strict React 19 ref typing; align declared refs to the real host elements.
 */
const NavigationMenuListPrimitive =
  NavigationMenuPrimitive.List as ForwardRefExoticComponent<
    Omit<NavigationMenuPrimitive.List.Props, "ref"> &
      RefAttributes<HTMLUListElement>
  >;

const NavigationMenuItemPrimitive =
  NavigationMenuPrimitive.Item as ForwardRefExoticComponent<
    Omit<NavigationMenuPrimitive.Item.Props, "ref"> &
      RefAttributes<HTMLLIElement>
  >;

const NavigationMenuIconPrimitive =
  NavigationMenuPrimitive.Icon as ForwardRefExoticComponent<
